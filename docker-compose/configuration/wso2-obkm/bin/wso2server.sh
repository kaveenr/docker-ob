...
mv ${CARBON_HOME}/dbscripts/consent/mysql-5.7.sql ${CARBON_HOME}/dbscripts/consent/mysql.sql
mv ${CARBON_HOME}/dbscripts/identity/mysql-5.7.sql ${CARBON_HOME}/dbscripts/identity/mysql.sql
mv ${CARBON_HOME}/dbscripts/identity/uma/mysql5.7.sql ${CARBON_HOME}/dbscripts/identity/uma/mysql.sql
